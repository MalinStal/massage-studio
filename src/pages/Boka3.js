  ...
  return (
    <main>
      <form className="boknings-form">
        ...
        <input
        className="form-input" name="mail" value={data.mail} onChange={handelChange} />
        <label className="form-label">Adress</label>
        <input
        className="form-input" name="adress" value={data.adress} onChange={handelChange} />
